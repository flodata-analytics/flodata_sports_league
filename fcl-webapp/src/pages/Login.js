        ...
        <div className="bg-white rounded-2xl shadow-xl px-6 py-8 sm:px-8 sm:py-10 flex flex-col items-center">
          ...
          <form className="w-full" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2 mt-3 px-4 rounded-lg bg-[#2c60ce] text-white font-semibold text-base shadow hover:bg-[#1746a2] transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#2c60ce] disabled:opacity-50 disabled:cursor-not-allowed mb-3"
            >
